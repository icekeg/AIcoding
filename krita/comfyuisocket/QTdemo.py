...
class Example:
    ...
    def __init__(self, prompt):    
        ...
        self.requeset = QtNetwork.QNetworkRequest(QUrl("http://127.0.0.1:8188/prompt"))
    ...
    def doRequest(self, prompt):   
        ...
        self.requeset = QtNetwork.QNetworkRequest(QUrl(url))
        self.requeset.setRawHeader(b"ngrok-skip-browser-warning", b"69420")
        ...
        self.requeset.setHeader(QtNetwork.QNetworkRequest.ContentTypeHeader, "application/json")
        self.requeset.setHeader(QtNetwork.QNetworkRequest.ContentLengthHeader, data_bytes.size())
        
        self.nam.post(self.requeset, data_bytes)
        #self.nam.get(req)

            #print(reply)
        #reply = self.nam.waitForFinished(-1)
    ...
    def handleResponse(self, reply):
        ...
        while True:
            reply = self.nam.get(self.requeset)
            if isinstance(reply,str):
                message = json.load(reply)
